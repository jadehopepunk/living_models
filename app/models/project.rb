...
#  REGIONS = ["Northland", "Auckland", "Coromandel", "Bay of Plenty", "Waikato", "Eastland", "Taupo","Hawkes Bay", "Taranaki", "Manawatu", "Wairarapa", "Wellington", "Nelson/Tasman", "Marlborough", "Canterbury", "West Coast", "Otago", "Southland",   "Stewart Island"]
...
#      {}
#    else
#      quoted_name = region_names.map {|name| ActiveRecord::Base.connection.quote(name)}
#      {:conditions => "region = #{quoted_name}"}
#    end
#  }
